 ...
 * Use the {@link TeamTwoFragment#newInstance} factory method to
...
public class TeamTwoFragment extends Fragment {
     ...
     * @return A new instance of fragment TeamTwoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TeamTwoFragment newInstance(String param1, String param2) {
        TeamTwoFragment fragment = new TeamTwoFragment();
    ...
    private void setUpProjectView() {
        cardViewFeed.setCardBackgroundColor(context.getResources().getColor(R.color.teammate_two));
        imageFeedProject.setImageResource(R.drawable.ic_twitter);
        tvFeedProject.setText("Team Developer 2: Twitter Project");
        tvFeedProjectDesc.setText("Build application exactly with Twitter application, write status anytime, anywhere.");
    }
}
