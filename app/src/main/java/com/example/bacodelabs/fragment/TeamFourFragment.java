 ...
 * Use the {@link TeamFourFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TeamFourFragment extends Fragment {
     ...
     * @return A new instance of fragment TeamFourFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TeamFourFragment newInstance(String param1, String param2) {
        TeamFourFragment fragment = new TeamFourFragment();
    ...
    private void setUpProjectView() {
        cardViewFeed.setCardBackgroundColor(context.getResources().getColor(R.color.teammate_four));
        imageFeedProject.setImageResource(R.drawable.ic_facebook);
        tvFeedProject.setText("Team Developer 4: Facebook Project");
        tvFeedProjectDesc.setText("Build application exactly with Facebook application, post photos and status anytime, anywhere.");
    }
